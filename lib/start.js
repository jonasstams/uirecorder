...
function startRecorder(options){
    ...
    var _browserSize = options.browsersize;
    var _continueRecord = options.continuerecord;
    console.log(options);
    if(locale){
    ...
    inquirer.prompt(questions).then(function(answers){
        ...
        var continueRecord = _continueRecord || false;
        var openChecker = false;
        var browserSize = _browserSize || '';
        ...
        function checkAllReady(){
            if(recorderBrowser && ((openChecker && checkerBrowser) || (mobile && recorderMobileApp) || !(openChecker || mobile))){
                if(continueRecord){
                    var testFile = path.resolve(_filepath);
